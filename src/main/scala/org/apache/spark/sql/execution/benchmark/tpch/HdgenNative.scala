...
import org.apache.spark.sql.execution.benchmark.Utils

case class HdgenNative() {
  ...
  val (dir, cmd) = {
    ...
    Seq("dbgen", "dists.dss").foreach { resource =>
